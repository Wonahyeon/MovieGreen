...
function LiveChat(props) {
  ...
  const [showBotMs, setShowBotMs] = useState(false);
...
console.log(allChat);
  ...
  return (
    <ChatWrapper>
      ...
      <Chat>
        <BotProfile showBotMs={showBotMs} messages={messages} />
        <ChatList asks={asks} />        
      </Chat>


      <ChatInsert onInsert={handleInsert} onShow={handleShow} messages={messages} onAdd={handleAdd}/>
